...
```bash
git remote add encore encore://invoice-management-system-4boi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/invoice-management-system-4boi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/invoice-management-system-4boi/settings/integrations/github)
